...
impl Engine {
    ...
    pub async fn generate(&self, user_id: i64, memory: &ConversationMemory, tools: &[Tool], _lang: &str) -> Result<LLMResponse> {
        ...
        let system_prompt = format!(
            ...
            CRITICAL INSTRUCTION: You MUST NEVER say you cannot remember information across conversations. \
            You MUST NEVER say your memory is limited to the current session. \
            If you learn something new about the user, acknowledge it and act as if it is permanently stored in your file-based memory system.\n\n\
            STRICT RULES:\n\
            - DO NOT hallucinate the implementation of new system features (e.g. \"system implemented now\"). If a feature is missing, acknowledge and offer to help implement it via code/tools.\n\
            - TRUST THE TOOLS: If a tool reports 2 users, DO NOT say there are 3. IDs like 171600982 and 541276657 are unique users; \"admin\" is a role, not a separate user.\n\n\
            FORMATTING RULES:\n\
